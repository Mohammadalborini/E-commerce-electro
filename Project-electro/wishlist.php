            ...
            <div class="row">
                ...
                if (!isset($_SESSION['id1'])) {
                    ...
                    if (isset($_GET['id1']) && isset($_GET['id'])) {
                        ...
                        $query5 = "SELECT * from wishlist where id_product = '$id' and id_user = '$id1' ";
                        $result5 = mysqli_query($conn, $query5);
                        if (mysqli_num_rows($result5) > 0) {
                            ...
                            $query = "INSERT INTO `wishlist`(`product_name`, `product_images`, `id_user`, `product_category`, `short_description`, `product_colors`, `product_price`, `discount`, `qty`,`id_product`) VALUES
                         ('$product_name','$piece2','$id1','$product_category','$description2','$color','$product_price','$discount','1','$id_product')";
                            $result = mysqli_query($conn, $query);
                        ...
                        $query5 = "SELECT * from wishlist where id_product = '$id' and id_user = '$id1' and point=1";
                        $result5 = mysqli_query($conn, $query5);
                        if (mysqli_num_rows($result5) > 0) {
                            echo '<h3 class="title pb-25 text-center text-md-left text-capitalize">The product already exist</h3>';
                        } else {
                            ...
                            $query = "INSERT INTO `wishlist`(`product_name`, `product_images`, `id_user`, `product_category`, `short_description`, `product_colors`, `product_price`, `discount`, `qty`,`id_product`,`point`) VALUES
                            ...
                            <tbody>
                                ...
                                ?>
                                        <tr class="text-center">
                                                ...
                                                <span class="whish-list-price">
                                                    ...
                                                    <?php } else { ?>
                                                        <a href="single-product-hot-deals.php?id=<?php echo $id_product; ?>&name=<?php echo $product_name1; ?>&category=<?php echo $product_category1; ?>">
                                                            <?php echo $product_name1; ?><br>
                                                            <p style="color: black; font-weight: bold;">Hot deals:<br> You must order this <br> product separately </p>
                                                        </a>
                                                    <?php } ?>
                                                </span>
                                            </td>
                                            ...
                                            <td class="text-center">
                                                <a href="wishlist.php?id_user=<?php echo $id1; ?>&id_product=<?php echo $id3; ?>" class="input" style="color:#fff;  background:red; padding: 7px;"> Delete </a><br><br>

                                                <?php if ($point == 0) { ?>
                                                    <a href="cart.php?id1_cart=<?php echo $id1; ?>&id_cart=<?php echo $id3; ?>" class="input" style="color:#fff;  background:green; padding: 7px;"> Add to cart </a>
                                                <?php } else { ?>
                                                    <a href="cart.php?id1_cart=<?php echo $id1; ?>&id_cart=<?php echo $id3; ?>&point=1" class="input" style="color:#fff;  background:green; padding: 7px;"> Add to cart </a>
                                                <?php } ?>
                                            </td>
                                ...
                                <?php  }
                                    ...
                                    echo '<h3 class="title pb-25 text-center text-md-left text-capitalize">There is no product in wishlist</h3>';
                                }
                                ?>
        ...
        if (isset($_GET['id_user']) && isset($_GET['id_product'])) {
            ...
            if (mysqli_num_rows($result4) > 0) {
                ...
                while ($row3 = mysqli_fetch_assoc($result4)) {
                    ...
                    echo '<script> window.location.href = "wishlist.php?true=true"; </script>';
                }
            }
        }
        ?>
