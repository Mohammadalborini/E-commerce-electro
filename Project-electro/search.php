                ...
                <div id="store" class="col-md-9">
                    <?php if ($_GET['select'] == 0) { ?>
                        ...
                        <div class="row">
                            ...
                            <?php else : echo '<h3 class="product-name"> There is no product in this name </h3>'; ?>
                    ...
                    <?php } else { ?>
                        <div class="row">
                            ...
                            $select = $_GET['select'];
                            $search = $_GET['search'];
                            $query = "SELECT * from product where product_name LIKE '%$search%' and product_category = '$select' ";
                            $result = mysqli_query($conn, $query);
                            if (mysqli_num_rows($result) > 0) :
                                while ($row = mysqli_fetch_assoc($result)) :
                                    $id = $row['id'];
