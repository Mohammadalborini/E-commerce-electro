                            ...
                            if (isset($_GET['id_product_cart']) && isset($_GET['id1'])) {
                                ...
                                if (mysqli_num_rows($result4) > 0) {
                                    ...
                                    while ($row3 = mysqli_fetch_assoc($result4)) {
                                        ...
                                        echo '<script> window.location.href = "single-product-product.php"; </script>';
                                    }
                                }
                            }
                            ?>
                        ...
                        <div class="col-md-5">
                            <div class="product-details">
                                ...
                                <div>
                                    <div class="product-rating">
                                        ...
                                        $query10 = "SELECT * from review where id_product='$id' and point = 1";
                                        $result10 = mysqli_query($conn, $query10);
                                        $num_rate1 = mysqli_num_rows($result10);
                                        if (mysqli_num_rows($result10) > 0) {

                                            $query11 = "SELECT SUM(rate) as 'reting1' from review where id_product='$id' and point = 1 ";
                                    ...
                                    <?php
                                    $query = "SELECT * from review where id_product='$id' and point = 1 ";
                                    $result = mysqli_query($conn, $query);
                                ...
                                <form method="POST" action="cart.php">
                                    ...
                                    ?>
                                        <div class="product-options">
                                            <label>
                                                Color
                                                <select class="input-select" name="color_product">
                                                    <?php
                                        ...
                                        <div class="add-to-cart">
                                            <div class="qty-label">
                                                ...
                                                <div class="input-number">
                                                    <input type="number" value="1" name="qty_product">
                                                    <span class="qty-up">+</span>
                                                    <span class="qty-down">-</span>
                                                </div>
                                            </div>
                                            <input type="hidden" name="id_product_product" value="<?php echo $id; ?>" />
                                            <button class="add-to-cart-btn" name="submit1"><i class="fa fa-shopping-cart"></i> add to cart</button>
                                        </div>
                                </form>
                            <?php } else {
                                        echo ' <span class="product-available">Quantity is out</span>';
                            ...
                            ?>
                                <ul class="product-btns">
                                    <li><a href="wishlist.php?id=<?php echo $id; ?>&id1=<?php echo $id1; ?>"><i class="fa fa-heart-o"></i> add to wishlist</a></li>
                                </ul>
                            <?php } else { ?>
                                        ...
                                        <div class="row">
                                            ...
                                            if (isset($_POST['review'])) {
                                                if (!isset($_SESSION['id1'])) {
                                                    ...
                                                    $id1 = $_SESSION['id1'];
                                                    $query = "SELECT * from review where id_user = '$id1' and id_product='$id' and point = 1";
                                                    $result = mysqli_query($conn, $query);
                                                    if (mysqli_num_rows($result) > 0) {
                                                        while ($row = mysqli_fetch_assoc($result)) {
                                                            $id_user = $row['id_user'];
                                                            ...
                                                            $query3 = "UPDATE `review` SET `rate`='$name4',`name`='$name1',`email`='$name2',`review`='$name3',`time_uploade`= NOW() WHERE id_user = '$id1' and id_product='$id' and point = 1";
                                                            ...
                                                            if (mysqli_num_rows($result4) > 0) {
                                                                ...
                                                                if (mysqli_num_rows($result11) > 0) {
                                                                    while ($row = mysqli_fetch_assoc($result11)) {
                                                                        ...
                                                                        $query10 = "UPDATE `product` SET `rate`='$rate2' WHERE id = '$id' ";
                                                                        mysqli_query($conn, $query10);
                                                                    }
                                                                }
                                                            }
                                                            echo '<script> alert ("The Review edited."); </script>';
                                                            echo '<script> window.location.href = "single-product-product.php?id=' . $id . '&name=' . $product_name . '&category=' . $cata . '"; </script>';
                                                        }
                                                    } else {

                                                        $query = "INSERT INTO `review`(`id_user`, `id_product`, `rate`, `name`, `email`, `review`, `point`) VALUES
                                                ('$id1','$id','$name4','$name1','$name2','$name3','1') ";
                                                        $result = mysqli_query($conn, $query);


                                                        $query1 = "SELECT * from review where id_product='$id' and point = 1";
                                                        ...
                                                        if (mysqli_num_rows($result1) > 0) {
                                                            ...
                                                            if (mysqli_num_rows($result11) > 0) {
                                                                while ($row = mysqli_fetch_assoc($result11)) {
                                                                    ...
                                                                    $query = "UPDATE `product` SET `rate`='$rate3' WHERE id = '$id'";
    ...
    <div class="section">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <!-- product -->
                <?php
                $query = "SELECT * from product where product_category = '$cata' and id != '$id' ";
                $result = mysqli_query($conn, $query);
                if (mysqli_num_rows($result) > 0) {
                        ...
                        <div class="col-md-3 col-xs-6">
                            <div class="product">
                                ...
                                <div class="product-body">
                                    ...
                                    <h3 class="product-name"><a href="single-product-product.php?id=<?php echo $id; ?>&name=<?php echo $product_name; ?>&category=<?php echo $cata; ?>"><?php echo $product_name; ?></a></h3>
                                    <?php
                                    if (!($discount) == null) {
                                        echo '<h4 class="product-price">' . $discount . ' JD<del class="product-old-price">' . $product_price . ' JD</del></h4>';
                                    } else {
                ...
                <?php
                    ...
                    echo '<h3 class="product-name">There is no more product</h3>';
                }
                ?>
                <!-- /product -->
