                    ...
                    <div class="center">
                        ...
                        <form method="POST" action="login-process.php">
                            ...
                            <div class="signup_link">
                                Not a member? <a href="Sign-in.php">Signup</a>
                            </div>
                        </form>
                        <?php if (isset($error)) : ?>
                    ...
                    <div class="col-md-4 col-xs-6">
                        ...
                        <div class="products-widget-slick" data-nav="#slick-nav-4">
                            <div>
                                ...
                                <div class="product-widget">
                                    <div class="product-body">
                                        <h3 class="product-name"><?php echo $first_name; ?></h3>
                                    </div>
                                </div>
                                <!-- /product widget -->
                                ...
                                <div class="product-widget">
                                    <div class="product-body">
                                        <h3 class="product-name"><?php echo $last_name; ?></h3>
                                    </div>
                                </div>
                                <!-- /product widget -->
                                ...
                                <div class="product-widget">
                                    <div class="product-body">
                                        <h3 class="product-name"><?php echo $username; ?></h3>
                                    </div>
                                </div>
                                <!-- product widget -->
                                <div class="product-widget">
                                    <div class="product-body">
                                        <h3 class="product-name"><?php echo $email; ?></h3>
                                    </div>
                                </div>
                                <!-- product widget -->
                                <div class="product-widget">
                                    <div class="product-body">
                                        <h3 class="product-name"><?php echo $phone; ?></h3>
                                    </div>
                                </div>
