    ...
    if (!empty($fileNames)) {
        foreach ($_FILES['files']['name'] as $key => $val) {
            ...
            if (in_array($fileType, $allowTypes)) {
                ...
                echo "<script> alert('The images is inappropriate.') </script>";
                echo '<script> window.location.href = "edit_produtc.php"; </script>';
            }
        }
    }

    //Now run update query 	
    $query = $conn->query("INSERT INTO `product`(`product_name`, `product_images`, `product_category`, `short_description`, `full_description`, `product_colors`, `product_price`, `discount`, `quantity_of_devices`) VALUES
