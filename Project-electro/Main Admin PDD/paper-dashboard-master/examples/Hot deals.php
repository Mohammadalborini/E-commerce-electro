            ...
            <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        ...
                        <a class="navbar-brand" href="javascript:;">Hot deals</a>
                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="divs">
                                <form action="" method="POST" enctype="multipart/form-data">
                                    ...
                                    <input type="text" name="rname2" id="nameo1" required>
                                    <label for="link1"> Price </label>
                                    <input type="text" name="name3" id="link1" required>
                                    <label for="link3"> Hot deals end (number of days to end) </label>
                                    <input type="text" name="name5" id="link3" required>
                                    <label for="link2"> Quantit of devices </label>
                                    <input type="text" name="name4" id="link2" required>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="table-responsive" style="overflow: hidden;">
                                            <?php
                                            $result = $conn->query("SELECT * FROM hot_deales") or die($conn->error);
                                            ?>
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php while ($row = $result->fetch_assoc()) :
                                                        ...
                                                        date_modify($uploaded_on, "+$days days");
                                                    ...
                                                    ?>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <?php echo $row['hot_deals_end']; ?>
                                                                </td>
                                                                <td class="text-right">
                                                                    <a href="edit_Hot deals.php?id=<?php echo $row['id']; ?>" class="divb"> Edit</a><br><br><br>
                                                                    <a href="Hot deals.php?id=<?php echo $row['id']; ?>" onclick="javascript: return confirm('Are you sure?');" class="divb" style="background:red;"> Delete</a>
                                                                </td>
                                                            </tr>
                                                            <?php $iq++; ?>
                                                </tbody>
                                        <?php
                                                            ...
                                                            while ($row = $result->fetch_assoc()) {
                                                                $id = $row['id'];
                                                                $sql = "DELETE FROM hot_deales WHERE id='$id' ";
                                                                mysqli_query($conn, $sql);

                                                                $sql = "DELETE FROM review WHERE id_product='$id' and point = 0 ";
                                                                mysqli_query($conn, $sql);

                                                                $sql1 = "DELETE FROM wishlist WHERE id_product='$id' and point = 1";
                                                                mysqli_query($conn, $sql1);

                                                                $sql2 = "DELETE FROM cart WHERE id_product='$id' and point = 1 ";
...
if (isset($_POST['submit'])) {
    ...
    $rname =  htmlspecialchars($_POST['rname1']);
    $name2 =  htmlspecialchars($_POST['name2']);
    $rname2 = htmlspecialchars($_POST['rname2']);
    ...
    $query = $conn->query("INSERT INTO `hot_deales`(`product_name`, `product_images`, `product_category`, `short_description`, `full_description`, `product_colors`, `product_price`, `quantity_of_devices`,`hot_deals_end`) VALUES
     ('$name1','$insertValuesSQL','$cart','$rname','$name2','$rname2','$name3','$name5','$name4')");
    echo "<script> alert('Add Hot deal.') </script>";
...
if (isset($_GET['id'])) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        echo "<script> alert('Hot deals Deleted.') </script>";
    }
}
?>