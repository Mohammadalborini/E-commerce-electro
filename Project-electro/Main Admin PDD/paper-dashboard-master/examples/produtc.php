                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            for ($i = 0; $i < count($piece); $i++) {
                                                                if (!empty($piece[$i])) {
                                                                    echo '
                                                                 <img src="../upload/' . $piece[$i] . '" style="width:100%; height:150px;" />
                                                                 ';
                                                                } else {
                                                        ...
                                                        <td>
                                                            <?php echo $row['product_colors']; ?>
                                                        </td>
                                                        <td>
                                                            <?php echo $row['product_price']; ?>
                                                        </td>
                                                        <td>
                                                            <?php echo $row['quantity_of_devices']; ?>
                                                        </td>
                                                        <td class="text-right">
                                                            <a href="edit_produtc.php?id=<?php echo $row['id']; ?>" class="divs"> Edit</a><br>
                                                            <a href="produtc.php?id=<?php echo $row['id']; ?>" onclick="javascript: return confirm('Are you sure?');" class="divs" style="background:red;"> Delete</a>
                                                        </td>
                                                    </tr>
                                                    <?php $iq++; ?>
                                                <?php endwhile; ?>
...
if (isset($_GET['id'])) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        $sql = "DELETE FROM cart WHERE id_product='$id' and point=0 ";
        mysqli_query($conn, $sql);

        $sql2 = "DELETE FROM review WHERE id_product='$id' and point=1 ";
        mysqli_query($conn, $sql2);

        $sql3 = "DELETE FROM wishlist WHERE id_product='$id' and point=0 ";
