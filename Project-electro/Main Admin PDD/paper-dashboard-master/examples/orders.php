                    ...
                    <div class="table-responsive" style="overflow: hidden;">
                      <table class="table" id="tbIDate">
                        ...
                        <tbody>
                          <?php
                          $i = 1;
                          $query2 = "SELECT * from orders ORDER BY `orders`.`user_name` ASC";
                    ...
                    <div class="table-responsive" style="overflow: hidden;">
                      <table class="table" id="tbIDate">
                        ...
                        <tbody>
                          <?php
                          $i = 1;
                          $query2 = "SELECT * from orders where id_user = '$id' ";
                          $result2 = mysqli_query($conn, $query2);
                          if (mysqli_num_rows($result2) > 0) {
                            while ($row1 = mysqli_fetch_assoc($result2)) {
                              $id = $row1['id'];
...
if (isset($_GET['id'])) {
  ...
  $id = $_GET['id'];
  $query4 = "SELECT * from orders where id = '$id' ";
  $result4 = mysqli_query($conn, $query4);
  if (mysqli_num_rows($result4) > 0) {
    while ($row3 = mysqli_fetch_assoc($result4)) {
      $id2 = $row3['id'];

      $query3 = "UPDATE `orders` SET `point2`='1' WHERE id = '$id2' ";
