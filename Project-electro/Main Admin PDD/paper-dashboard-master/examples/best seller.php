                  ...
                  <div class="table-responsive" style="overflow: hidden;">
                    <table class="table">
                      ...
                      <tbody>
                        ...
                        $i = 1;
                        $query = "SELECT * from product order by numer_seller DESC limit 6";
                        $result = mysqli_query($conn, $query);
                        if (mysqli_num_rows($result) > 0) {
                        ...
                        ?>
                            <tr>
                              ...
                              <td>
                                <?php
                                $pieces1 = $product_images;
                                $piece = explode(",", $pieces1);
                                    echo '
                                                                 <img src="../upload/' . $piece[0] . '" style="width:100px; height:auto;" />
                                                                 ';
                                 ?>
                              </td>
